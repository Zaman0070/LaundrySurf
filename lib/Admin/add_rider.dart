...
class _LoginScreenState extends State<AddRider> {
          ...
          child:  TextFormField(
            ...
            validator: (value){
              if(value == null || value.isEmpty){
                return 'Enter Rider phone number';
              }
              return null;
            },
      ...
      child: RaisedButton(
        ...
        onPressed: (){
          ...
          if(formKey.currentState!.validate()){
            if(imageUrl!=null){
              services.riderRegister(emailTextController.text, passwordTextController.text, context, phoneTextController.text,imageUrl,nameTextController.text,);
            }
            else{
