...
class AdminPickOrderDetails extends StatefulWidget {
  int? index;

    AdminPickOrderDetails({Key? key,required this.index}) : super(key: key);


  @override
  State<AdminPickOrderDetails> createState() => _AdminPickOrderDetailsState();
}

class _AdminPickOrderDetailsState extends State<AdminPickOrderDetails> {
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            Center(child: Text(widget.index==0?'Admin Pick by Rider':"Admin Make Order For ready",style: TextStyle(color: const Color(0xff381568),fontSize: 15.sp,fontWeight: FontWeight.bold),)),
            SizedBox(height: 1.h,),
            Center(child: Text(widget.index==0?'After pickup the order so confirmed its.':"",style: TextStyle(fontSize: 12.sp,fontWeight: FontWeight.w400,color: Colors.grey.shade500),)),
            SizedBox(height: 2.h,),
            Column(
          children: [
            Container(
            ...
            InkWell(
              onTap: () async {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                   const SnackBar(
                    content: Text('Order has been successfully Picked!'),
                  ),
                );
              ...
              child: Container(
                ...
                child:  Center(
                  child: Text(widget.index==0?'Confirmed Pick':"Ready To Deliver",style: TextStyle(color: Colors.white),),
                ),
              ),
            ),
          ],
