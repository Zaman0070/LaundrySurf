...
import 'package:laundry_app/Admin/about_user/search_users.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text('List of All User',style: TextStyle(color: Colors.black),),
        centerTitle: true,
        ...
        child: ListView(
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
              future: service.users.where('type',isEqualTo: 'user').get(),
