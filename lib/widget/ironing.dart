...
class Ironing extends StatefulWidget {
  const Ironing({Key? key}) : super(key: key);

  @override
  State<Ironing> createState() => _IroningState();
}
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              InkWell(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (_)=> SchedulePickUp(orderFor: 'Ironing',)));
                },
                child: Container(
                  height: 5.h,
                  width: 100.w,
